...
coordinated-claimant-design: selfsame SPEC-008 0.5.4-draft
coordinated-hub-design: cbcl-bus SPEC-053 0.17.4-draft
coordinated-pairing-design: cbcl-pairing SPEC-001 0.5.3-draft
...
generation-synthesis-trajectory: "approved 0.2.1 cutover -> standalone credential/v2 ordering conflict -> rejected reviews through 0.5.3 -> direct 0.3.2 safety closure"
...
> **Current draft safety revision.** Version 0.3.2 states the credential/v2
...
## Gate Evidence Record — 0.3.2-draft
...
gates:
  - gate: "Accepted rejection imported before repair"
    ...
    result: pass
    evidence: "[[spec-008-0.5.3-claude-adversarial-review-2026-08-24]] records REJECT and the N-1 through N-11 findings"
  - gate: "Coordinated 0.3.2 and 0.5.4 Tier-1 review returns PASS"
...
- Selfsame SPEC-008 0.5.4-draft, cbcl-bus SPEC-053 0.17.4-draft,
  and cbcl-pairing SPEC-001 0.5.3-draft pass one coordinated Tier-1 review;
